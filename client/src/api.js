...
const socket = io(`http://${window.location.hostname}:5261`);
...
export const deleteMock = mock => new Promise(resolve => {
    socket.emit('DELETE_MOCK', mock, compose(resolve, getOr(null, 'data')));
});
